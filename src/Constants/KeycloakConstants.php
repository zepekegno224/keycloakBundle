...
final class KeycloakConstants
{
     ...
     */
    public const SESSION_TARGET_PATH = 'keycloak_target_path';
    public const SESSION_REDIRECT_AFTER_LOGIN = 'keycloak_redirect_after_login';
    ...
    public static function getAllSessionKeys(): array
    {
        return [
            ...
            self::SESSION_STATE,
            self::SESSION_TARGET_PATH,
            self::SESSION_REDIRECT_AFTER_LOGIN,
            self::SESSION_TOKENS,
        ];
    }
